...
export const getCharacter = (request: express.Request, response: express.Response) => {
...
export const getCharacterProfile = (characterName: string, realmSlug: string) => {
...
export const getCharacterEquipment = (characterName: string, realmSlug: string) => {
...
export const getCharacterRaidProgression = (characterName: string, realmSlug: string) => {
...
export const getCharacterSpecialization = (characterName: string, realmSlug: string) => {
...
export const getCharacterStatistics = (characterName: string, realmSlug: string) => {
